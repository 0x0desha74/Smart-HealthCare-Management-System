...
{
    public class UpcomingDoctorAppointmentsSpecifications : BaseSpecification<Appointment>
    {
        public UpcomingDoctorAppointmentsSpecifications(PaginationDto specParams, string userId) : base(a => a.Doctor.AppUserId == userId && a.Status == AppointmentStatus.Pending)
        {
